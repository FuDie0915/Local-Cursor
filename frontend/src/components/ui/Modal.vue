    ...
    <Transition name="modal-mask">
      ...
      >
        <Transition name="modal-content">
          <div
            v-show="visible"
            class="relative z-10 w-full max-w-[360px] overflow-hidden rounded-[8px] border border-[#383838] bg-[#141414] p-5 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.8)]"
            @click.stop
          >
            <h3 class="mb-3 text-base font-medium text-white">
              {{ title }}
            </h3>
            <p class="mb-5 max-h-[55vh] overflow-y-auto whitespace-pre-wrap text-sm leading-relaxed text-[#a8a8a8]">
              {{ content }}
            </p>
