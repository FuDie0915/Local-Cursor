...
<template>
  <div ref="rootRef" class="relative">
    <button
      ...
      type="button"
      :disabled="disabled"
      class="flex h-9 items-center rounded-[4px] bg-[#141414] px-3 text-left text-sm text-white outline-none transition-colors disabled:cursor-not-allowed disabled:opacity-60"
      :class="[
        border
  ...
  <Teleport to="body">
    ...
    >
      <div
        v-if="isOpen"
        ref="menuRef"
        class="fixed z-[999] overflow-hidden rounded-[8px] border border-[#383838] bg-[#141414] p-1 shadow-[0_16px_30px_-12px_rgba(0,0,0,0.8)]"
        :class="menuClass"
        :style="menuStyle"
      >
