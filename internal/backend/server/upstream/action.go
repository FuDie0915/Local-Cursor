...
func AgentUsableModelsMockBuilder(reqCtx *RequestContext) (map[string]any, error) {
	return buildAgentUsableModelsPayload(reqCtx)
}

func AgentDefaultModelForCliMockBuilder(reqCtx *RequestContext) (map[string]any, error) {
	return buildAgentDefaultModelForCliPayload(reqCtx)
}
